...
pub fn Sidebar() -> Element {
    ...
    let shell_class = "sidebar flex flex-col w-56 min-w-56 bg-sidebar-bg border-r border-sidebar-border md:[&.collapsed]:w-14 md:[&.collapsed]:min-w-14 max-lg:pt-[env(safe-area-inset-top)] max-lg:pb-[env(safe-area-inset-bottom)] max-lg:pl-[env(safe-area-inset-left)] max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:h-dvh max-lg:w-[280px] max-lg:min-w-[280px] max-lg:z-[1000] max-lg:-translate-x-full max-lg:transition-transform max-lg:duration-[250ms] max-lg:ease-out max-lg:shadow-ui-lg max-lg:[&.open]:translate-x-0 max-lg:[&.collapsed]:w-[280px] max-lg:[&.collapsed]:min-w-[280px]";
    ...
    rsx! {
        aside {
            ...
            div { class: "py-2 px-1.5 border-t border-sidebar-border md:[.sidebar.collapsed_&]:py-2 md:[.sidebar.collapsed_&]:px-1",
                ...
                // project links. Stacks vertically in the collapsed
