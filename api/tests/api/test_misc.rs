                   ...
                   Some(
                       &HeaderValue::from_str(
                           &format!(
                               ...
                               "default-src 'self'; script-src 'self' 'wasm-unsafe-eval' 'sha256-uAESwGgY2G0W8BhcAjQ5tDZK88YZcbjq65DW8JTcims='; style-src 'self' 'unsafe-inline'; object-src 'none'; connect-src 'self' {}; img-src * 'self' data:; font-src 'self'; worker-src 'none'; frame-src 'self'; frame-ancestors 'self'; base-uri 'self'; form-action 'self'",
